    ...
    <div class="content">
        <div class="block block-rounded text-center">
            <div class="block-content">
                <h3 class="text-center">Edit Campaign Details</h3>
            </div>
        </div>
    </div>
    <div class="content">
                        ...
                        <form id="regForm" method="POST" action="{{ route('user.getData') }}" class="js-validation" novalidate="novalidate" enctype="multipart/form-data">
                                ...
                                <div class="row items-push">
                                    <div class="col-md-4">
                                        <div class="form-check form-block">
                                            <input type="radio" required="" class="form-check-input"  value="{ { old('objective')=='Increase Purchase' ? 'checked='.''.'checked'.''' : '' } }" id="example-radio-block1" name="objective">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-block">
                                            <input type="radio" required=""  class="form-check-input" value="{{ old('objective', optional($camp)->objective) }}" id="example-radio-block2" name="objective">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-block">
                                            <input type="radio" required=""  class="form-check-input" value="{{ old('objective', optional($camp)->objective) }}"  id="example-radio-block3" name="objective">
                            ...
                            <div class="tab">
                                ...
                                <div class="row items-push">
                                    <div class="col-md-3">
                                        <div class="form-check form-block">
                                            <input type="radio" required="" class="form-check-input" value="{{ old('objective', optional($camp)->objective) }}" id="7days" name="days">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check form-block">
                                            <input type="radio" required="" class="form-check-input" value="{{ old('objective', optional($camp)->objective) }}" id="30days" name="days">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check form-block">
                                            <input type="radio" required="" class="form-check-input" value="{{ old('objective', optional($camp)->objective) }}" id="60days" name="days">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check form-block">
                                            <input type="radio" required="" class="form-check-input" value="{{ old('objective', optional($camp)->objective) }}" id="90days" name="days">
